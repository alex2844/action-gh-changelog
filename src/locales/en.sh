...
I18N["usage_opt_l"]="  -l, --lang <code>     Language of the output (en, ru)."
...
# Warnings
I18N["warn_api_dep_missing"]="Utility '%s' not found. Cannot use the GitHub API."
I18N["warn_remote_url_unrecognized"]="Could not parse the remote URL format: %s"
I18N["warn_remote_origin_missing"]="Remote 'origin' not found. Using local commits only."
I18N["warn_token_missing"]="GitHub token not found. API data will not be fetched."
I18N["warn_api_fetch_failed"]="Failed to fetch data from the API. One of the tags might not exist on the remote."
I18N["warn_api_fetch_failed_fallback"]="Failed to fetch data from the API, using local commits only."

# Log messages
I18N["log_repo_discovery"]="🔍 Discovering repository..."
I18N["log_repo_found"]="Remote repository found: %s"
I18N["log_repo_is_github"]="GitHub repository detected. Checking API dependencies..."
I18N["log_api_deps_ok"]="API dependencies found."
I18N["log_repo_is_other_host"]="Repository on %s detected. Using local commits only."
...
I18N["log_mode_by_date"]="Date-based generation mode selected."
...
I18N["log_tag_from_arg"]="Using tag from argument: %s"
I18N["log_range_from_to"]="from %s to %s"
I18N["log_no_tags_found"]="No tags found, using all commits from the beginning of the repository"
I18N["log_commits_after_tag"]="Found %d commits since the last tag %s"
I18N["log_generating_for_unreleased"]="Generating changelog for unreleased changes"
I18N["log_no_commits_after_tag"]="No new commits since the last tag, using latest tag: %s"
...
I18N["log_calculating_next_version"]="🔍 Calculating next version..."
I18N["log_changelog_generation_start"]="🔍 Generating changelog..."
I18N["log_mode_raw_list"]="Raw list output mode selected."
I18N["log_mode_grouped"]="Grouped sections mode selected."
